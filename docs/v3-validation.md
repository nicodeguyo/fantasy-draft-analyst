...
- 80 behavioral/correctness tests passed, including real local HTTP requests, CLI imports, undo, stale-state handling, concurrent writer rejection, source outages, source period/scoring validation, roster coverage, projection sensitivity and held-out evaluation boundaries.
